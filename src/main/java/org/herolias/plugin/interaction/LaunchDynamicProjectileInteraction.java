...
public class LaunchDynamicProjectileInteraction
        extends com.hypixel.hytale.server.core.modules.projectile.interaction.ProjectileInteraction {
    ...
    protected void firstRun(@Nonnull InteractionType type, @Nonnull InteractionContext context,
        ...
        boolean bl = hasClientState = clientState != null && clientState.attackerPos != null
