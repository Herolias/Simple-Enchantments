...
public class WorkbenchRefreshSystem extends EntityTickingSystem<EntityStore> {
    ...
    public void tick(float dt, int index,
        ...
        // During the upgrade (2-4 seconds), the vanilla CraftingManager cancels
        // crafting
        // and clears out the upgrading items. We must not force an invalidation during
        // this
        ...
        // Player has an open bench window. Get its current tier level from its data
        // json
        // Using windowData because BenchWindow has no public getTierLevel() method but
        // exposes it in data
