...
<div class="se-stats-cell se-stats-value" style="border-top: 1px solid rgba(148, 163, 184, 0.18); display: flex; align-items: center; min-height: 38px; padding: 7px 0;">Speed Per Level: <code>25%</code></div>
...
<div class="se-stats-cell se-stats-value" style="border-top: 1px solid rgba(148, 163, 184, 0.18); display: flex; align-items: center; min-height: 38px; padding: 7px 0;"><code>fast_swim</code></div>
