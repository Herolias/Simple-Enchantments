...
The search bar contains every item in the game, including creative-only and modded items, so make sure your preferred item is obtainable in survival. In theory, you can add as many ingredients as you want, except for table upgrade costs. Table upgrade costs support up to 5 ingredients because larger recipes are not supported by the Hytale UI yet. They may still work, but they will look strange in-game.
