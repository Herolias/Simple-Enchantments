...
For the shorter task checklist, start with [How to Build Your Own Enchantment](https://wiki.hytalemodding.dev/mod/simple-enchantments/how-to-build-your-own-enchantment). This page is the longer code-oriented walkthrough.
